			...
			<div class="row">
				<div class="col-sm-5">
                    <div class="form-group" :class="{error: validation.hasError('patient_id')}">
                        ...
                        <br>
						<button style="float: right;" type="button" class="btn  btn-primary waves-effect" v-if="!show" @click="search"><strong>VIEW RECORD</strong></button>
						<button style="float: right;" type="button" class="btn  btn-danger waves-effect" v-if="show" @click="search"><strong>Cancel</strong></button>
                    </div>
                </div>
                <div class="col-sm-5">
