							...
							<div class="col-md-5">
								<div class="form-group">
				                    <div class="borderBottom">
					                    ...
					                    <select class="form-control show-tick" v-model="manualLeave.department">
					                        <option v-for="dept in departments" :value="dept.department_name">{{dept.department_name}}</option>
					                    </select>
					                </div>
				                </div>
							</div>
	...
	export default {
		...
		methods:{
	        ...
	        sendAddLeaveManuallyData(){
	        	var self = this
	        	this.$http.post(apiDomain + 'api/addLeaveManually',self.manualLeave)
	        		.then(response => {
