		...
		<div class="container" style="margin-top: 25px;margin-left: 50px;">
			<div class="row">
				...
				<div class="col-md-2 text-right m-b-20">
					<router-link class="btn  btn-raised bg-blue-grey waves-effect fa fa-plus" to="/admin/receptionist/add_receptionist"><strong>Add Receptionist</strong></router-link>
				</div>
			</div>
			<div class="row">
				<div class="col-md-10">
			...
			<div class="row">
					<div class="col-md-11 border">
						<div class="ui container">
					        ...
					        <router-link to="/admin/receptionist/edit_receptionist" class="ui button yellow"><i class="edit icon"></i></router-link>
